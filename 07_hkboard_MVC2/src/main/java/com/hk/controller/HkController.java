...
//			pageContext.forward("boarddetail.jsp");
			...
			if(isS){
				//브라우저에 주소창에 응답URL로 변경된다.
	 			response.sendRedirect("boardlist.board");
				//브라우저에 주소창에 요청 URL로 적용된다.
...
//	 			response.sendRedirect("error.jsp?mag="+URLEncoder.encode("글삭제할때 최소하나이상체크해야합니다.","utf-8"));
//	 		}else{
...
//	 		}
	...
	//JS location 구현
	public void jsLocation(String msg,String url,HttpServletResponse response) throws IOException {
		String jsLocation=
				"<script type='text/javascript'>"
					+"alert('"+msg+"');"
					+"location.href='insertboardform.board';"
