...
//		dto.setBirthYear(1971);
		//생성자 오버로딩을 사용했을 경우
//		UserDto dto=new UserDto("KKA", "김경호", 1971, "전남", "019", "123456", 177, null);
//		boolean isS=dao.insertUser(dto);//파라미터를 DTO객체를 통해 전달.
//		System.out.println("회원정보등록성공:"+isS);
		//회원정보 수정
		boolean isSUpdate=dao.updateUser(new UserDto("KKH","김건모",1970,"서울","011","12345678",170,null));
